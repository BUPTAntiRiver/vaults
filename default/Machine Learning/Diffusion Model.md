...
Remember we were doing sampling in the forward process right? So we are only doing $T$ times of sampling of Gaussian in the forward process, and we were also doing 